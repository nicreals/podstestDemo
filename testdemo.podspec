...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/testdemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '聂锐' => 'nrui@wanfantian.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/testdemo.git', :tag => s.version.to_s }
